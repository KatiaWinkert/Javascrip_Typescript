...
//exportando padrão a class GeraCPF (rand é para gerar numeros)
...
var valida_cpf = new ValidaCPF('070.987.720-90');
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,600;1,100&family=Open+Sans:ital,wght@0,700;1,400&display=swap);"]);
// Module
